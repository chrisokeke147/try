...
const styles = StyleSheet.create({
  ...
  primaryLabel: { color: colors.textPrimary, fontSize: typography.sizes.subtitle, fontFamily: typography.fontFamilySemiBold },
  secondaryLabel: { color: colors.textOnDark, fontSize: typography.sizes.subtitle, fontFamily: typography.fontFamilySemiBold },
});
